...
- Suite: 29 tests green (`pytest -q` → `29 passed`), incl. 4 real-Chromium
  offline e2e tests. Demo verified: `processed=3 enriched=2 failed=0
  blocked=1 skipped=0`, real PNG receipts on disk.
